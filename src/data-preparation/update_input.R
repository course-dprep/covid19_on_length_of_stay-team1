...
file.copy("./data/dataset1/dataset2020.csv.gz","./gen/data-preparation/input/dataset2020.csv.gz")
file.copy("./data/dataset2/dataset2022.csv.gz","./gen/data-preparation/input/dataset2022.csv.gz")
